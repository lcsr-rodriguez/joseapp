 ...
 * 
 */
public abstract class ManagerNumeros {
	 ...
	 * @since 1.0
	 */
	public static String convertirnumeros(double number) {
		return convertirnumeros(doubleToString(number));
	}
	 ...
	 * @since 1.0
	 */
	public static String convertirnumeros(String number)
			throws NumberFormatException {
